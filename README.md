...
목표 선정과 힌트 유무를 분리합니다. 랜덤·라운드의 출발과 목표, 새 일일 목표는 15,199개 제목 스냅샷을 사용하며 직접 지정도 가능합니다. 현재 나무위키 전체 목록은 아니고 리다이렉트나 변경된 제목이 포함될 수 있습니다. 원문과 정확히 다른 제목으로 응답하면 자동 힌트에서 제외하며 모든 목표의 힌트를 보장하지 않습니다.
